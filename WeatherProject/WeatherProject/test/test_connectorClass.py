...
sys.path.append(r'C:\Users\jaspe\WeatherProject\WeatherProject\WeatherProject')

# Now you can import the SQLiteConnector class
from src.connectorClass import SQLiteConnector
...
class TestSQLiteConnector(unittest.TestCase):
    ...
    def test_insert_model_results(self):
        ...
        self.connector.insert_model_results(
            ...
            order=(5, 1, 0), forecast_steps=10, model_summary='Test Summary', mse=0.1, mae=0.05,
        ...
        self.assertEqual(rows[0][12], '2000-01-01')  # train_start
        self.assertEqual(rows[0][13], '2007-12-01')  # train_end
        self.assertEqual(rows[0][14], '2008-03-01')  # test_start
        self.assertEqual(rows[0][15], '2010-03-01')  # test_end
        conn.close()
